...
dt_string = 'Wloclawek/' + now.strftime("%d-%m-%Y %H-%M-%S")
import os
...
# save setup
setup_file_name = 'results/' + dt_string + '/jensenshannon_setup.csv'
...
results_file_name = 'results/' + dt_string + '/jensenshannon_results.csv'
with open(results_file_name, 'a') as fd:
    fd.write("flow_id,s,exp(mu),error\n")

# file with solutions
solution_file_name = 'results/' + dt_string + '/jensenshannon_solution.csv'
with open(solution_file_name, 'a') as fd:
    fd.write("Y,y_pred\n")

for flow_id in range(len(flows)):
    # file with optimization results
    optimization_file_name = 'results/' + dt_string + '/jensenshannon_optimization_' + str(flow_id) + '.csv'
